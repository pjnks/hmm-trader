...
- **CITRINE** running 82-ticker long-only live test. **Sprint 9 risk engine DEPLOYED (2026-03-31)**: Chandelier exit (entry_atr × 2.0), ATR position sizing, conf velocity exit, MAE/MFE tracking. **Sprint 11 shadow tracker DEPLOYED (2026-04-02)**: parallel allocator with relaxed thresholds (conf≥0.70, persist≥1, max 30 pos) logs theoretical trades for low-N analysis. **Sprint 12 (2026-04-04, DEPLOYED)**: Chandelier day-0 immunity + execution-observation fix + dashboard P&L decomposition (7 fixes). Current: $24,663 equity, 9 positions, 59% cash, 249 trades. Realized P&L: -$544, Unrealized: +$191.
